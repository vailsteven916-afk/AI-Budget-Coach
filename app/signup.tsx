    ...
    <View className="flex flex-col h-[100dvh] bg-white dark:bg-zinc-950 text-zinc-900 dark:text-white p-6 max-w-md mx-auto">
      <View className="flex-1 flex flex-col justify-center">
        ...
        >
          ...
          <Text className="text-zinc-500 dark:text-zinc-400">Join AI Budget Coach today</Text>
        </View>
        ...
        >
          ...
          <TouchableOpacity
            type="submit"
            className="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-semibold py-4 rounded-xl transition-colors active:scale-[0.98] mt-4"
          >
            Sign Up
          </TouchableOpacity>
      ...
      <View className="pb-8 text-center">
        <Text className="text-zinc-500 dark:text-zinc-400 text-sm">
          ...
          <Link href="/login" className="text-emerald-600 dark:text-emerald-400 font-semibold">Log in</Link>
        </Text>
      </View>
    </View>
  );
